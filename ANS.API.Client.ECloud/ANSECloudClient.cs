...
{
    public partial class ANSECloudClient : ANSClient, IANSECloudClient
    {
        public ANSECloudClient(IConnection connection) : base(connection)
        {
        }

        public ANSECloudClient(IConnection connection, ClientConfig config) : base(connection, config)
        {
        }
